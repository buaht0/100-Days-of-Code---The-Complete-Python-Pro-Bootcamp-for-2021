...
# Hint 13: Create a function called compare() and pass in the user_score and computer_score. If computer and user both have the same score, then it's a draw. If the computer has a blackjack(0), then the user loses. If the computer_score is over 21, then the computer loses. If none of the above, then the player with the highest score wins.
...
def play_game():
  ...
  # Hint 12: Once the user is done, its time to let to computer play. The computer should keep drawing cards as long as it has a score less than 17.
